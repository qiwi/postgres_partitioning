...
select settings.pm_create_enabled partitions_create_enabled,
       ...
       extract(EPOCH from settings.pm_create_forward)::integer
           / extract(EPOCH from settings.pm_part_interval)::integer partitions_create_forward_count, --- desired forward creation partition count
